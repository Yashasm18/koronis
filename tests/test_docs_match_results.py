...
# It cannot see two documents stating the same quantity differently. Most of
# that class is covered by tests/test_docs_claims_reconcile.py; the one it does
# not cover is the test count, which is stated in three places at once.

def test_the_test_count_is_the_same_everywhere_it_is_stated():
    """Badge, README quickstart and CONTRIBUTING each state it; they must agree."""
