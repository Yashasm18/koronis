...
[![tests](https://img.shields.io/badge/tests-183%20passing-2ea44f)](tests/)
...
.venv/bin/python -m pytest tests/ -q              # 183 tests, ~1-2 min
...
skip — but then 176 are collected rather than 183, and the test-count check says so.
...
| What broke? | 15 defects, **4 retracted claims** | [Engineering log](docs/engineering-log.md) |
