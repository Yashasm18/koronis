...
[![tests](https://img.shields.io/badge/tests-254%20passing-2ea44f)](tests/)
...
.venv/bin/python -m pytest tests/ -q              # 254 tests, ~2 min
...
skip — but then 246 are collected rather than 254, and the test-count check says so.
