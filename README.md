<h1><img src="docs/assets/koronis-mark.svg" alt="" height="34"> Koronis</h1>
...
[![tests](https://img.shields.io/badge/tests-265%20passing-2ea44f)](tests/)
...
.venv/bin/python -m pytest tests/ -q              # 265 tests, ~2 min
...
skip — but then 256 are collected rather than 265, and the test-count check says so.
...
| What broke? | 30 defects, and **11 published claims withdrawn** | [Engineering log](docs/engineering-log.md#claims-withdrawn) |
