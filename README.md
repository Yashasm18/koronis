...
[![tests](https://img.shields.io/badge/tests-268%20passing-2ea44f)](tests/)
...
skip — but then 259 are collected rather than 268, and the test-count check says so.
...
| What broke? | 31 defects, and **11 published claims withdrawn** | [Engineering log](docs/engineering-log.md#claims-withdrawn) |
